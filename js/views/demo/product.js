define([
  'view',
  'text!templates/demo/product_list.html',
  'collections/product'
], function( Vm, productlistTemplate,productCollection){
  var DashboardPage = Backbone.View.extend({
   initialize: function(option)
    ...
    el: '.inner_container',
    render: function () {
      var post = new productCollection(this.opt);
      var that = this ;
        post.fetch({
          success:function(col,res){
           ...
           var now_page = 1;
            ...
            if(that.opt.i!=undefined)
              ...
              page_pre_href+='/';
              $(that.el).html(_.template(productlistTemplate,{now_page:now_page,page_pre_href:page_pre_href,posts:res.res,count:res.count,page_count:page_count}));
              $('.carousel').carousel();
          },
