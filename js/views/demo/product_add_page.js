define([
  ...
  'views/demo/index',
  'views/demo/product_add'
], function( Vm, indexTemplate,HeaderView,ServerNotOkView,ServerOkCollection,IndexView,
  ProductAddView){
      ...
      var serverok = new ServerOkCollection();
        serverok.fetch({
          success:function(res){
              ...
              headerView.render();
              var pageView =  Vm.create(this,'pageView', ProductAddView,that.options);
              pageView.render();
          },
